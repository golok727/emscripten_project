...
["_main","_memory","_getCanvasWidth","_getCanvasHeight","___indirect_function_table","_fflush","___start_em_js","___stop_em_js","onRuntimeInitialized"].forEach((prop) => {
...
Module['FS_createPath']("/", "emscripten_project", true, true);
Module['FS_createPath']("/emscripten_project", "src", true, true);
Module['FS_createPath']("/emscripten_project/src", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/lib.data');

      };
      Module['addRunDependency']('datafile_bin/lib.data');
    ...
    loadPackage({"files": [{"filename": "/emscripten_project/src/resources/basic.glsl", "start": 0, "end": 379}], "remote_package_size": 379});
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('lib.wasm', import.meta.url).href;
}
...
var ___start_em_js = Module['___start_em_js'] = 81684;
var ___stop_em_js = Module['___stop_em_js'] = 81761;
